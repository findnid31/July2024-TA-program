...
namespace SpecFlowProjectTM.Specflow
{
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("create time record with data")]
        [NUnit.Framework.CategoryAttribute("regression")]
        public void CreateTimeRecordWithData()
        {
            string[] tagsOfScenario = new string[] {
                    "regression"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("create time record with data", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 9
